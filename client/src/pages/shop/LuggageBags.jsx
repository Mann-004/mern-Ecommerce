...
const LuggageBags = () => {
  ...
  return (
    <div
      className="relative w-full bg-gradient-to-br from-indigo-100 via-white to-purple-200 px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-12 md:py-16 lg:py-20 overflow-hidden"
    > 
      ...
      <div className="text-center mb-10 sm:mb-12 md:mb-16 relative">
        ...
        <p
          className="text-gray-600 text-base sm:text-lg md:text-xl lg:text-2xl font-light max-w-xl sm:max-w-2xl mx-auto leading-relaxed"
        >
              ...
              >
                <div className="relative w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px] overflow-hidden rounded-t-2xl sm:rounded-t-3xl">
                  <div className="absolute top-3 sm:top-4 left-3 sm:left-4 z-40">
                    <span className="bg-gradient-to-r from-red-400 to-pink-400 text-white text-xs sm:text-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl font-bold shadow-md sm:shadow-xl backdrop-blur-sm border border-white/30 transform hover:scale-105 transition-transform">
                      {discountPercent}% OFF
                    </span>
                  </div>

                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4 z-40">
                    <span className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl font-bold shadow-md sm:shadow-xl flex items-center gap-1 uppercase">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span className="text-xs sm:text-sm text-gray-400">Travel Ready</span>
                      </div>
